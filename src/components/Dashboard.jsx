...
const Dashboard = ({ onSelectFilter }) => {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="relative overflow-hidden rounded-[32px] apple-glass p-6 sm:p-8 border border-white/10 shadow-2xl">
      ...
      {/* Top 4 KPI Metrics (Apple Fitness Rings Style) */}
